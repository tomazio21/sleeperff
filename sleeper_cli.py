...
from format import get_standings_text, get_matchups_text, get_power_rankings_text, get_trophies_text
    ...
    for week in range(1, number_of_weeks_played + 1):
        ...
        for matchup in parsed:
            ...
            if matchup_id in weekly_matchups:
                weekly_matchups[matchup_id].add_opponent_data(matchup['roster_id'],matchup['points'])
            else:
                weekly_matchups[matchup_id] = Matchup(matchup['roster_id'],matchup['points'],week)
...
if __name__ == '__main__':
    ...
    for week in range(1, number_of_weeks_played + 1):
        ...
        print(get_trophies_text(get_trophies(weekly_matchups, roster_ids_to_team_name)))
        print()
